...
\begin{align*}
	...
	\frac{2}{3} &= r
\end{align*}
This non-dimensional look on problems like these will come in handy to simplify more involved equations.

Of course, this scenario is not exemplary of Lagrange points, let alone the interaction between celestial bodies. Let us think increase the complexity of our initial system by having $m_2$ in a circular orbit around $m_1$. With consideration for rotational force, centripetal force is expressed as:
\begin{equation*}
...
Note how our equation for acceleration is dependent on the distance an object is from either body.
Should we try to predict the motion of an object, its movement, there would be no way to express distance as a function of time.
This is a major hurdle that occurs in physics and, while there exists specific situations where this can be overcome, most of the time there is no solution.
